		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					...
					<p class="float-right mt-4 "><a href="workflow.php">Workflow</a> | <a href="pesquisar-marcos.php">Marcos</a> | <a href="pesquisar-atividades.php">Atividades</a> |<a href="pesquisar-tarefas.php"> Tarefas</a></p>
		...
		--->
					...
					<table id="example" class="display">
						...
						<tbody>
							...
							?>
								<tr>
									<td><a class="text-dark"><?php echo $registros['id'] ?><?php echo $registros['cad-numero-registro'] ?></a></td>
									...
									<td><a class="text-dark" style="width:80px"><?php echo $registros['itemQa'] ?></a></td>
