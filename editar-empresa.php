...
<form action="processa-atualizar-empresa.php" method="post">	
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<span class="text-white breadcrumb-item"><a href="dashboard.php" class="text-light">Dashboard</a> | Editar Empresa</span>
						</div>
					</div>
	...
	<div class="row ml-4 mr-4">
		<div class="col-md-12">
			...
			<h3 class="mb-4 mt-4">Editar Empresa </h3>
		</div>
	...
	<input type="text" class="form-control" name="cad-atividade-economica" id="cad-atividade-economica" value="<?php echo $registros['atividade_economica'] ?>"  >
		...
		<div class="col-md-4 mb-4">
			<label>Pais</label>
		<select name="cad-paises" id="cad-paises" class="form-control">
	...
	<option value="Zâmbia">Zâmbia</option>
		...
		<div class="col-md-2 mb-4">
			<label>Número</label>
			<input type="text" class="form-control" name="cad-numero" id="cad-numero" value="<?php echo $registros['numero'] ?>" >
		</div>
		...
		<div class="col-md-5 mb-4">
			<label>Site</label>
			<input type="url" class="form-control" name="cad-site" id="cad-site"  placeholder="https://site.com.br" data-toggle="tooltip" data-placement="top" title="Exemplo: https://site.com.br" autocomplete="off" >
		</div>
