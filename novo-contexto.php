...
<!-- Navegação !-->	
	...
	<input type="button" class="btn btn-primary mb-3" value="Voltar" onclick='history.go(-1)'><br>
 	<h3 class="mb-4 mt-4">Nova Análise</h3>			
	...
	<div id="conteudo1">	
		...
		<div class="col-md-4 mb-3">
			...
			<input type="text" class="form-control" name="cad-nome-analise" id="cad-nome-analise" onChange="Analise()">
		</div>
			
			
		<div class="col-md-4 mb-3">
			<label>Objetivo da Análise</label>
			<input type="text" class="form-control" name="cad-objetivo" id="cad-objetivo">
		</div>
			
			
		<div class="col-md-4 mb-3">
			<label>Data Criação</label>
			<input type="text" class="form-control datepicker" name="cad-data" id="cad-data" value="<?php echo date('d-m-Y') ?>">
		</div>	
		...
		<div class="col-md-12 mt-4 mb-3">
			<input type="submit" class="btn btn-primary" value="Gravar Análise">	
		</div>	
...
function AdicionarMembro(){
		...
		$('.close').trigger('click')
		$("#carregar-tabela-membros").load('funcoes/carregar-tabela-membros-contexto-temp.php')
	...
	function CarregarTabelaMembros(){
		  $j.ajax({
			  type: 'post',
			  data: 'codigo=',
			  url:'funcoes/carregar-tabela-membros-contexto-temp.php',
			  success: function(retorno){ 
...
LimparTabelaFatoresInternos()
		  ...
		  $j.ajax({
			  type: 'post',
			  data: 'codigo=',
			  url:'funcoes/carregar-tabela-fatores-internos.php',
			  success: function(retorno){
	...
	function CarregarTabelaFatoresExternos(){
		LimparTabelaFatoresExternos()		 
		  $j.ajax({
			  type: 'post',
			  data: 'codigo=',
			  url:'funcoes/carregar-tabela-fatores-externos.php',
			  success: function(retorno){
