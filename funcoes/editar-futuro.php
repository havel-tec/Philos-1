...
?>
<form action="processa-editar-futuro.php" method="post" >
<div class="row " >
    ...
    <input type="hidden" id="codigo_matriz" name="codigo_matriz" value="<?php echo $codigo_matriz ?>">
	 <input type="hidden" id="classif_risco" name="classif_risco" value="<?php echo $classi_risco ?>">
       ...
       <div class="col-md-6 mt-3">
           ...
           <input type="text" name="cad-nivel-do-risco-futuro"  id="cad-nivel-do-risco-futuro" readonly value="<?php echo $nivel ?>"  >
       </div>
	...
	if($numer>1){	   
       ...
       <div class="col-md-6">
        ...
        <input type="hidden" id="titulos[]" name="titulos[]" value="<?php echo $registros_item ?>">  
           ...
           <select class="form-control"  name="futuro[]" id="cad-<?php echo $registros_impacto['id']; ?>" onChange="CoresNiveis('cad-<?php echo $registros_impacto['id']; ?>')">
...
?>
    ...
    <?php } ?>          
        ...
        <input type="submit" class="btn btn-primary" value="Atualizar Risco futuro">
