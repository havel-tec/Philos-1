...
mysqli_query($conexao,'SET character_set_results=utf8');
				$selecao=mysqli_query($conexao,"select * from comites_atas where codigo_comite='$codigo'");
            ...
            <tr>
				...
				<td><a class="text-dark" href="ata.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['termino'] ?></a></td>
				 ...
				 <td>
					...
					<i class="fa fa-edit" style="cursor: pointer" data-toggle="modal" data-target="#ModalEditarAta" onClick="EditarModalAta(<?php echo $registros['id'] ?>)" ></i>	
