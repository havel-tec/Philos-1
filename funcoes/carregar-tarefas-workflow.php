...
<table class="table">
    <script>
        function calcula_prazo() {
            ...
            var difference = Math.abs(dateA1 - dateC1);
    ...
    ?>
        ...
        <tr>
            <th><label>Data da devolutiva</label>
                <h4>
                    <input type="date" value="<?php echo $registros['dtDevolutiva']; ?>" class="form-control" id="dtDevolutiva" onBlur="calcula_dataDevolutiva()">
                </h4>
            </th>
        ...
        <tr>
            <th><label>Dias de atraso para retorno com o prazo</label>
                <h4>
                    <input value="<?php echo $registros['diasRetPrazo']; ?>" class="form-control" type="number" id="diasRetPrazo" pattern="[0-9]+$">
                </h4>
            </th>
        ...
        <tr>
            <th><label>Data de atendimento do plano de ação</label>
                <h4>
                    <input type="date" value="<?php echo $registros['datAtendPlanAcao']; ?>" class="form-control" id="datAtendPlanAcao" onChange="calcula_dataAtendimento()">
                </h4>
            </th>
