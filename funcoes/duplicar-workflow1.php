...
$inserir=mysqli_query($conexao,"insert into workflow(planejamento,prioridade,descricao,data_vencimento,data,hora,data_inicio)values('$planejamento','$prioridade','$descricao','$data_vencimento','$data_criacao','$hora_criacao','$data_inicio')");

$selecao1=mysqli_query($conexao,"select * from _workflow ORDER BY id DESC");
...
<?php
$inserir_fase=mysqli_query($conexao,"insert into fases_workflow(fase,descricao,data_inicio,data_termino,data,hora,codigo_planejamento)values('$fase','$descricao_fase','$data_inicio_fase','$data_termino_fase','$data_criacao','$hora_criacao','$codigo_novo') ");	
?>	
