...
<form action="processa-atualizar-terceiro.php" method="post">	
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<span class="text-white breadcrumb-item"><a href="dashboard.php" class="text-light">Dashboard</a> | Editar Empresa de Parceiro</span>
						</div>
					</div>
	...
	<div class="row ml-4 mr-4">
		<div class="col-md-12">
			...
			<h3 class="mb-4 mt-4">Editar Empresa de Parceiro </h3>
		</div>
		...
		<div class="col-md-2 mb-4">
			...
			<input type="number" class="form-control" name="cad-num" id="cad-num" value="<?php echo $id ?>" >
		</div>
	...
	?>
		<input type="checkbox" name="cad-classificacao[]" value="Cliente" <?php if($cliente==1){?> checked <?php } ?>> Cliente	<br>
		<input type="checkbox" name="cad-classificacao[]" value="Fornecedor" <?php if($fornecedor==1){?> checked <?php } ?>> Fornecedor<br>			
		<input type="checkbox" name="cad-classificacao[]" value="Terceiro" <?php if($terceiro==1){?> checked <?php } ?>> Terceiro		
