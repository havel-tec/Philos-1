...
<!-- Navegação !-->	
	...
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<a href="dashboard.php"><span class="text-white breadcrumb-item">Dashboard | Documento</span></a>
						</div>
					</div>
    ...
    <div id="conteudo1">
 	<h3 class="mb-4 mt-5 ml-4 mr-4">&nbsp;&nbsp;Documento 
	...
	$verificar_grupo=mysqli_query($conexao,"select * from grupos_permissoes WHERE codigo_menu='14' and codigo_grupo='$cod_grupo' and editar='1' ");
			...
			if($numero_grupo>=1){	
			?>		
    <a href="editar-documento.php?cod=<?php echo $codigo_procedimento ?>">
	...
	<div class="row ml-4 mr-4">
		...
		<div class="col-md-5 mb-4">
			...
			<input type="text" class="form-control" name="cad-numero-revisao" id="cad-numero-revisao" readonly value="<?php echo $registros['nome_procedimento'] ?>">
		</div>
...
function CarregarTabela(){
   ...
   $f.ajax({
			  ...
			  url:'funcoes/carregar-requisitos-ver.php',
			  success: function(retorno){
			  $f('#resposta-tabela').html(retorno); 
