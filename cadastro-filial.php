...
<form action="processa-cadastro-filial.php" method="post">	
	...
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<a href="dashboard.php"><span class="text-white breadcrumb-item">Dashboard | Cadastro Filial</span></a>
						</div>
					</div>
...
<!-----------FILIAIS--------->
	<?php include('filiais.php') ?>
	<div id="resposta-filiais"></div>
...
<!-----------FINAL FILIAIS--------->	
		...
		<div class="col-md-12">
			<input type="submit" class="btn btn-primary" value="Adicionar Filial">
		</div>
