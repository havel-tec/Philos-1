...
$inserir=mysqli_query($conexao,"insert into tarefas_planejamento_workflow1(tarefa,prioridade,descricao,data,hora,codigo_planejamento,data_inicio,data_termino)values('$tarefa','$prioridade','$descricao','$data_criacao','$hora_criacao','$codigo','$data_inicio','$data_termino')");
