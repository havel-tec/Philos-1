...
$selecao=mysqli_query($conexao,"select * from upload_cadastro");
...
?>
		...
		<tr>
			...
			<td class="text-danger" style="cursor: pointer" onClick="Deletar(<?php echo $registros['id'] ?>)"><strong>X</strong></td>
		</tr>				
