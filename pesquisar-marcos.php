		...
		<div class="container-fluid">
			...
			<div class="row">
				<div class="col-12">
					...
					<form action="pesquisar-marcos.php" method="post">
					...
					<table id="example" class="display">
						...
						<thead>
							<tr>
								...
								<th>Término</th>
								<th>Status</th>
								<th style="width:80px">Item Qaa</th>
								<th style="width:110px">Responsável pelo processo</th>
								<th style="width:110px">Responsável pela Ação</th>
								<th>Departamento</th>
								<th>Planta</th>
								<th style="width:120px">Plano de ação</th>
								<th style="width:120px">Mapa de risco</th>
								<th style="width:200px">Data de envio do plano de ação</th>
								<th style="width:200px">Data para retorno com o prazo</th>
								<th style="width:120px">Data da devolutiva</th>
								<th style="width:200px">Dias de atraso para retorno com o prazo</th>
								<th style="width:120px">Status prazo devolutiva</th>
								<th style="width:200px">Prazo para atendimento do plano de ação</th>
								<th style="width:250px">Data de atendimento do plano de ação</th>
						...
						<tbody>
							...
							if (@$_POST['min'] == '') {
								$selecao = mysqli_query($conexao, "select * from fases_workflow  inner join tarefas_atividades_workflow  ");
							} else {
							...
							?>
								<tr>
									<td><a class="text-dark" href="planejamento-workflow.php?cod=<?php echo $registros['codigo_planejamento'] ?>"><?php echo $registros['codigo_planejamento'] ?></a></td>
									...
									<td><a class="text-dark" style="width:80px"><?php echo $registros['itemQaa'] ?></a></td>
									...
									<td><a class="text-dark"><?php echo $registros['diasRetPrazo'] ?></a></td>

									<td><a class="text-dark"><?php echo $registros['statusDevolutiva'] ?></a></td>

									<td><a class="text-dark"><?php echo $registros['pzAtendPlanAcao'] ?></a></td>

									<td><a class="text-dark"><?php echo $registros['datAtendPlanAcao'] ?></a></td>

									<td><a class="text-dark"><?php echo $registros['diasAtraso'] ?></a></td>

									<td><a class="text-dark"><?php echo $registros['statusPrazoPlanoAcao'] ?></a></td>
