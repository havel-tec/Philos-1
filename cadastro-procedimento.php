...
<form action="processa-cadastro-procedimento.php" method="post">	
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<a href="dashboard.php"><span class="text-white breadcrumb-item">Dashboard | Cadastro procedimento</span></a>
						</div>
					</div>
...
<input type="button" class="btn btn-primary ml-2 mr-2 pointer" id="btn1" onClick="Abas(1)" value="Procedimentos">
...
<input type="button" class="btn btn-light ml-2 mr-2 pointer" id="btn3" onClick="Abas(3)" value="Cadastro de Referência e Requisitos Normativos"
    ...
    <div id="conteudo1">
 	<h3 class="mb-4 mt-5 ml-4 mr-4">&nbsp;&nbsp;Cadastro de novo procedimento</h3>	
	...
	<div class="row ml-4 mr-4">
		...
		<div class="col-md-2 mb-4">
			...
			<input type="number" class="form-control" name="cad-numero-revisao" id="cad-numero-revisao">
		</div>
...
mysqli_query($conexao,'SET character_set_results=utf8');
  ...
  <div id="resposta-tabela"></div>
		...
		<div class="col-md-4 mb-4">
			...
			<select class="form-control" name="cad-elaborado-por" id="cad-elaborado-por">
				<option value="0">Escolha</option>
            <?php
            $selecao_areas=mysqli_query($conexao,"select * from usuarios_empresa");
            while($registros_areas=mysqli_fetch_array($selecao_areas)){
            ?>
                <option><?php echo $registros_areas['email'] ?></option>
