		...
		<div class="container-fluid">
			<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<span class="text-white breadcrumb-item"><a href="dashboard.php" class="text-light">Dashboard</a> | Atividades - Workflow de Atividades</span>
						</div>
					</div>
			...
			<div class="row">
				<div class="col-12">
					...
					<h3 class="mb-4 mt-4 float-left">Atividades - Workflow de Atividades</h3>
					...
					<form action="pesquisar-atividades.php" method="post">
					...
					<table id="example" class="display" style="width:100%">
						...
						<thead>
							<tr>
								...
								<th style="width:150px">Data de envio do plano de ação</th>
						...
						<tbody>
							...
							if (@$_POST['min'] == '') {
								$selecao = mysqli_query($conexao, "select * from atividades_planejamento_workflow");
							} else {

								$selecao = mysqli_query($conexao, "select * from atividades_planejamento_workflow WHERE data_inicio >='$data_min' and data_termino <='$data_max' ");
							}
							...
							?>
								<tr>
									<td><a class="text-dark" href="planejamento-workflow.php?cod=<?php echo $registros['codigo_planejamento'] ?>"><?php echo $registros['id'] ?></a></td>
									<td><a class="text-dark"><?php echo $registros['atividade'] ?></a></td>
									...
									<td><a class="text-dark" style="width:110px"><?php echo $registros['descricao'] ?></a></td>
			...
			if (window.confirm("Tem certeza que deseja excluir a Atividade?")) {
				...
				$.ajax({
					...
					success: function(retorno) {
						...
						location.href = 'pesquisar-atividades.php'
					}
				})
