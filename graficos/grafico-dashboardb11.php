...
sectorPieBefore = am4core.create("sectorPieBefore999", am4charts.PieChart3D);
	...
	mysqli_query($conexao,'SET character_set_results=utf8');
		...
		$selecao=mysqli_query($conexao,"select * from avaliacao_risco_futuro WHERE nivel='Aceitável' and data BETWEEN '$de' and '$ate'    ");
		...
		<?php
		$selecao=mysqli_query($conexao,"select * from avaliacao_risco_futuro WHERE nivel='Inaceitável' and data BETWEEN '$de' and '$ate'    ");
		$registros=mysqli_fetch_array($selecao);	
		$nivel=mysqli_num_rows($selecao);
		 ...
		 {"sector":"Inaceitável",
		  ...
		  <?php
		$selecao=mysqli_query($conexao,"select * from avaliacao_risco_futuro WHERE nivel='Significativo' and data BETWEEN '$de' and '$ate'    ");
		$registros=mysqli_fetch_array($selecao);	
		$nivel=mysqli_num_rows($selecao);
		 ...
		 {"sector":"Significativo",
		   ...
		   <?php
		$selecao=mysqli_query($conexao,"select * from avaliacao_risco_futuro WHERE nivel='Sério' and data BETWEEN '$de' and '$ate'    ");
		$registros=mysqli_fetch_array($selecao);	
		$nivel=mysqli_num_rows($selecao);
