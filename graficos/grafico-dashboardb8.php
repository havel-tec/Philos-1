...
<html>
  <head>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.1.4/Chart.min.js"></script>
		...
		<div id="columnchart_values77" class="chart" style="height: 350px; "></div>
 ...
 <script type="text/javascript">
	...
	mysqli_query($conexao,'SET character_set_results=utf8');
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById("columnchart_values77"));
