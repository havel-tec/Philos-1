...
<html>
  <head>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/Chart.js/2.1.4/Chart.min.js"></script>
		...
		<div id="columnchart_values33" class="chart" style="height: 350px; "></div>
 ...
 <script type="text/javascript">
    ...
    function drawChart() {
      var data = google.visualization.arrayToDataTable([
        ["Nível de Avaliação - Risco inerente", "Quantidade", { role: "style" } ],
	...
	mysqli_query($conexao,'SET character_set_results=utf8');
				...
				$selecao2=mysqli_query($conexao,"select * from avaliacao_risco_inerente WHERE nivel='Aceitável' and data BETWEEN '$de' and '$ate' ");
	...
	mysqli_query($conexao,'SET character_set_results=utf8');
      ...
      var options = {
        title: "Níveis da Avaliação de Riscos inerentes(Qtd)",
      ...
      var chart = new google.visualization.ColumnChart(document.getElementById("columnchart_values33"));
