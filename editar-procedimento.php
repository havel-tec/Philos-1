...
<form action="processa-atualizar-procedimento.php" method="post">
	...
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<a href="dashboard.php"><span class="text-white breadcrumb-item">Dashboard | Editar procedimento</span></a>
						</div>
					</div>
...
<input type="button" class="btn btn-light ml-2 mr-2 pointer" id="btn3" onClick="Abas(3)" value="Cadastro de Referência e Requisitos Normativos"
    ...
    <div id="conteudo1">
 	<h3 class="mb-4 mt-5 ml-4 mr-4">&nbsp;&nbsp;Editar procedimento</h3>	
	...
	<div class="row ml-4 mr-4">
		...
		<div class="col-md-2 mb-4">
			...
			<input type="number" class="form-control" name="cad-numero-revisao" id="cad-numero-revisao" value="<?php echo $registros['numero_revisao'] ?>">
		</div>
