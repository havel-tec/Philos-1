...
<!-- Navegação !-->	
	...
	<table id="example" class="display" style="width:100%">
        ...
        <tbody>
			...
			?>
            <tr>
                <td><a class="text-dark" href="planejamento.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['planejamento'] ?></a></td>
				
                <td><a class="text-dark" href="planejamento.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['prioridade'] ?></a></td>
				
                <td><a class="text-dark" href="planejamento.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['data_inicio'] ?> </a></td>
				
				<td><a class="text-dark" href="planejamento.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['data_vencimento'] ?></a></td>
                <td>
