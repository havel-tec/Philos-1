...
<form action="processa-cadastro-empresa-terceiro.php" method="post">	
	<input type="hidden" name="codigo_empresa_principal" value="<?php echo $codigo ?>">
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<a href="dashboard.php"><span class="text-white breadcrumb-item">Dashboard | Cadastro Empresa Parceiros</span></a>
						</div>
					</div>
...
<!-----------TERCEIROS--------->
	<?php include('terceiros.php') ?>
	<div id="resposta-terceiros"></div>
...
<!-----------TERCEIROS--------->	
		...
		<div class="col-md-12">
			<input type="submit" class="btn btn-primary" value="Adicionar Empresa de Parceiro">
		</div>
