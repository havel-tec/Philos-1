...
<!-- Navegação !-->	
	...
	$verificar_grupo=mysqli_query($conexao,"select * from grupos_permissoes WHERE codigo_menu='22' and codigo_grupo='$cod_grupo' and cadastrar='1' ");
 	...
 	<a href="cadastro-rnc.php"> <img src="imgs/icone-mais.png" width="25" height="25" alt=""/> Novo RNC</a>	
	<?php } ?>				
	...
	<table id="example" class="display" style="width:100%">
        ...
        <tbody>
			<?php
			$selecao=mysqli_query($conexao,"select * from rnc ");	
            ...
            <tr>
                ...
                <td><a class="text-dark" href="rnc.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['emitente'] ?></a></td>
				
                <td><a class="text-dark"  href="rnc.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['data'] ?></a></td>
				
                <td><a class="text-dark" href="rnc.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['processo'] ?> </a></td>
				
					 <td><a class="text-dark" href="rnc.php?cod=<?php echo $registros['id'] ?>"><?php echo $registros['tipo'] ?></a></td>
				
				 <td><a class="text-dark" href="rnc.php?cod=<?php echo $registros['id'] ?>">
					 
					 
					 <?php echo $registros['status'] ?></a></td>
				<td>
					
					<?php
	$verificar_grupo=mysqli_query($conexao,"select * from grupos_permissoes WHERE codigo_menu='22' and codigo_grupo='$cod_grupo' and editar='1' ");
			$numero_grupo=mysqli_num_rows($verificar_grupo);
			if($numero_grupo>=1){	
			?>	
					<a class="text-dark" href="editar-rnc.php?cod=<?php echo $registros['id'] ?>" >
