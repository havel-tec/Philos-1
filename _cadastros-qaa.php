...
<div class="list-group-item">
	<a class="text-dark" href="#sub-menu"  data-toggle="collapse" data-parent="#main-menu">
...
<div class="collapse list-group-level1" id="sub-menu">	
					...
					<div class="list-group-item "  id="item-de-menu">
                     <a href="#sub-sub-menu"  data-toggle="collapse" data-parent="#sub-menu" onClick="ClicarQuestao()">
						titulo 1 
					</a>
							<span class="float-right" onClick="DelQuestao()"><i class="fa fa-trash"></i></span>
					</div>
   
                    <div class="collapse list-group-level2" id="sub-sub-menu">
                        <a href="#" onClick="ClicarQuestao()"  class="list-group-item" data-parent="#sub-sub-menu">
							Título 1
						</a>
                    </div>
	</div>						   
...
<div class="list-group-item">
	<a class="text-dark" href="#sub-menu2"  data-toggle="collapse" data-parent="#main-menu">
...
<div class="modal fade" id="NovaQuestao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" style="z-index: 999999; ">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Adicionar Nova Questão</h5>
      ...
      <div class="modal-body">
		  ...
		  <label class="mt-3">Título da Questão</label>
		  <input type="text" class="form-control" id="cad-titulo-questao">
		  
		  
		  <label class="mt-3">Questão</label>
		<textarea id="cad-questao" class="form-control"></textarea>  
		  
		  
		  <label class="mt-3">Resposta</label>
		  <textarea id="cad-resposta" class="form-control"></textarea>
		  
		  
      </div>
      <div class="modal-footer">
       
        <button type="button" class="btn btn-primary" onClick="GravarQuestao()">Gravar Questão</button>
      </div>
    </div>
  </div>
</div>		
