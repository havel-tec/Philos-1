...
<!-- Navegação !-->	
	...
	<div class="content-wrapper">
		...
		<div class="row mb-5" style="margin-top: -16px; ">
				<div class="col-md-12 bg-padrao position-fixed p-2 text-right" style="z-index: 999999">
					...
					<div class="row">
						<div class="col-md-9">
							<span class="text-white breadcrumb-item"><a href="dashboard.php" class="text-light">Dashboard</a> | Filial</span>
						</div>
					</div>
		...
		<div class="col-md-12">
			...
			<h3 class="mb-4 mt-4">Filial <a href="editar-filial.php?cod=<?php echo $codigo ?>"><img src="imgs/icone-editar.png" width="30" height="30" alt=""/></a></h3>
		</div>
	...
	<input type="text" class="form-control" name="cad-data-fundacao" id="cad-data-fundacao" value="<?php echo $registros['data_fundacao'] ?>"  readonly>
			...
			<div class="col-md-4 mb-4">
			<label>Pais</label>
			<input type="text" class="form-control" name="cad-pais" id="cad-pais" value="<?php echo $registros['pais'] ?>" readonly>
		</div>
		...
		<div class="col-md-2 mb-4">
			<label>Número</label>
			<input type="number" class="form-control" name="cad-numero" id="cad-numero" value="<?php echo $registros['numero'] ?>" readonly>
		</div>
