    ...
    ?>
        ...
        <div class="col-md-1 mb-4">
         ...
         <div class="col-md-10 mb-4">
           <label>Evento de Risco  <i class="fa fa-edit pointer"  data-toggle="modal" data-target="#exampleModal2" onClick="EditarAtualizarRisco()"></i></label>
...
if($exibir_impacto==5){$exibir_impacto='Insignificante';}
if($exibir_impacto==8){$exibir_impacto='Baixo';}
if($exibir_impacto==17){$exibir_impacto='Moderado';}
if($exibir_impacto==27){$exibir_impacto='Alto';}
	...
	?>
	 <div class="col-md-2">
		<label>Decisão de Tratamento do Risco</label>
		  <?php $decis= $registros_avaliacao['decisao']; if($decis=='0'){$decis='Não Escolhido';}else{$decis= $registros_avaliacao['decisao'];} ?>
...
mysqli_query($conexao,'SET character_set_results=utf8');
      ...
      while($registros_inerente=mysqli_fetch_array($selecao_itens2)){  
	   ...
	   $title=$registros_inerente['titulo'];
		 ...
		 if($title=='Op. Estratégica '){$title='Operacional/Estratégica';} 
...
if($itensx=='Baixa'){$itensx='baixa';}		  
if($itensx=='Média'){$itensx='media';}
if($itensx=='Alta'){$itensx='alta';}
if($itensx=='Muito Alta'){$itensx='malta';}		  
...
if(calcular<=16){resultado='Aceitável'; cor ='#41841E' }
if(calcular >=17 && calcular <= 34  ){resultado='Significativo'; cor ='#F2E70A'}
if(calcular >=40 && calcular <= 85  ){resultado='Sério'; cor ='#E58C2C'}
if(calcular >=108 && calcular <= 200  ){resultado='Inaceitável'; cor ='#FF0000'}
...
function EditarInerente(classif_risco){
	...
	function SalvarEfeito(tipo){
		...
		if(tipo=='Método'){
			...
			var efeito = $b('#cad-efeito1').val()
		}
		
		if(tipo=='Medidas'){
			
			var efeito = $b('#cad-efeito2').val()
		}
		
		if(tipo=='Mão de Obra'){
			
			var efeito = $b('#cad-efeito3').val()
		}
		
		if(tipo=='Máquina'){
			
			var efeito = $b('#cad-efeito4').val()
		}
		
		if(tipo=='Meio Ambiente'){
			
			var efeito = $b('#cad-efeito5').val()
		}
		
		if(tipo=='Materiais'){
			
			var efeito = $b('#cad-efeito6').val()
		}
